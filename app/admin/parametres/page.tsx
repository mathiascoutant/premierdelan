      ...
      <div className="space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-8">
          <div className="flex items-center space-x-3 mb-4 md:mb-6">
            <FiBell className="w-5 h-5 md:w-6 md:h-6 text-black" />
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-8">
          <div className="flex items-center space-x-3 mb-4 md:mb-6">
            <FiShield className="w-5 h-5 md:w-6 md:h-6 text-black" />
            <h2 className="text-lg md:text-xl font-medium text-black">
              Sécurité
            </h2>
          </div>
          <div className="space-y-4">
            <div>
              ...
              <div className="flex gap-3">
                ...
                />
                <button className="btn-secondary">Générer nouveau</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-8">
          <div className="flex items-center space-x-3 mb-4 md:mb-6">
            <FiDatabase className="w-5 h-5 md:w-6 md:h-6 text-black" />
            <h2 className="text-lg md:text-xl font-medium text-black">
              Base de données
            </h2>
          </div>
